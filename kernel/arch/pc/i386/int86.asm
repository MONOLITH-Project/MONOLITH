...
;        int86() resets all selectors.
;
; C Prototype:
;   void _cdelc int86(unsigned char intnum, regs16_t *regs);
;
; Example of usage:
;   regs.ax = 0x0013;
;   int86(0x10, &regs);
...
section .text
    ...
    ib: db 0x00
        ...
        mov  sp, int86_BASE                    ; set correct stack position so we can copy back
    ...
    int86_end:                                 ; end marker (so we can copy the code)
